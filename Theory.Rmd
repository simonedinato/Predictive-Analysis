...
Calcolo del leverage: In R, puoi calcolare il leverage utilizzando la funzione hatvalues() dopo aver adattato il tuo modello di regressione. Il risultato sarà un vettore di valori di leverage, uno per ciascuna osservazione nel tuo dataset.
...
Rimozione dei punti influenti: Se i punti influenti risultano essere effettivamente outlier o dati errati, puoi considerare l'opzione di rimuoverli dal tuo dataset. Questa operazione può migliorare la bontà del modello eliminando dati che potrebbero distorcerne i risultati.
