...
ChatGPT I Modelli Lineari Generalizzati (GLM) forniscono un quadro flessibile per estendere la regressione lineare classica a una vasta gamma di tipi di dati.
...
Un risultato maggiore di uno indica una probabilità positiva (η), un rapoorto minore di 1 indica una probabilità negativa (1 - η).

La funzione logit ci permette di avere risultati nell'intervallo [-♾️, +♾️]
