...
## Modelli Lineari Generalizzati (GLM) {#modelli-lineari-generalizzati-glm}

I Modelli Lineari Generalizzati (GLM) estendono il framework della regressione lineare per gestire un'ampia gamma di distribuzioni dei dati e tipologie di risposte.
...
**Formulazione Matematica:** La forma generale di un GLM può essere rappresentata come segue:
...
La devianza è una misura della discrepanza tra il modello statistico e i dati osservati nei Modelli Lineari Generalizzati (GLM).
