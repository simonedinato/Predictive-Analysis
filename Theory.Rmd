...
X <- as.matrix(Housing[, c("sqft", "bdrms", "age")])
...
- Il peso del veicolo sembra essere il fattore più significativo nella determinazione del consumo di carburante
