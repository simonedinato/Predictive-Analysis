...
Per ulteriori informazioni contattami su uno dei miei social che puoi trovare [qui](https://simonedinato.github.io).
...
p_value <- summary(anova_result)[[1]][["Pr(>F)"]][3]  # Usiamo [3] per estrarre il valore relativo all'interazione
